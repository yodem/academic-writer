...
description: "Guided research ideation — brainstorm research questions using 5W1H, gap analysis, and structured framing. Outputs a research brief that feeds into /academic-writer."
user-invocable: true
...
Write a `research-brief.md` file that feeds directly into `/academic-writer`:
...
*Feed this into /academic-writer to start writing.*
```
...
>
> To start writing, run `/academic-writer`. The brief will be loaded automatically as a starting point."
